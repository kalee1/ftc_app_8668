...
@Autonomous(name="Blue Front CV", group="Jewel")

/**
 * e404_BlueFront extends <code>Error404JewelAutonomousCV</code> class and has the encoder distances for this quadrant.
 *
 * @author Team 8668
 * @See Error404JewelAutonomous
 * */
public class e404_BlueFrontCV extends Error404JewelAutonomousCV

{
    ///////////////////////////////////////////////////////////////////

    /** The quadrant the robot is in. */
    public e404_BlueFrontCV()
    {
